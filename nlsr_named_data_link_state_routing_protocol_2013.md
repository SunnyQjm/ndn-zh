...
![image-20191218163022162](assets/image-20191218163022162.png)
...
本节我们将就处理时间、消息传递开销和收敛时间三个方面评估NLSR的性能。所有的测试在六个具有不同操作系统和系统规格的异构节点组成的网络上进行，具体的网络拓扑如图4所示。需要特别说明的是，我们为了在短时间内对协议进行测试，我们将刷新时间设置为30分钟，而不是几天。

![image-20191218165324161](assets/image-20191218165324161.png)

<center>图 4  网络拓扑</center>
![image-20191218165903818](assets/image-20191218165903818.png)
...
![image-20191218165624433](assets/image-20191218165624433.png)
...
![image-20191218172652141](assets/image-20191218172652141.png)
